...
fun CollectionType.name(ctx: Context) = ctx.getString(when (this) {
    ...
    CollectionType.STONE_RUBBLE -> R.string.collectiontype__STONE_RUBBLE
    CollectionType.WOOD -> R.string.collectiontype__WOOD
