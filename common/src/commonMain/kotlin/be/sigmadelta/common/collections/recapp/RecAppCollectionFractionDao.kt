...
data class CollectionFractionLogoDao(val id: String) {
    fun toCollectionType() = when (id) {
        ...
        "5d610b86162c063cc0400120", // TODO: OLD METALS ON DEMAND
        "5d610b86162c063cc0400122" -> CollectionType.OLD_METALS
        "5d610b86162c063cc0400129" -> CollectionType.RE_USE_CENTER
        "5d610b86162c063cc0400121" -> CollectionType.SOFT_PLASTICS
        ...
        "5d610b86162c063cc0400103" -> CollectionType.STONE_RUBBLE
        "5d610b86162c063cc0400132" -> CollectionType.WOOD
